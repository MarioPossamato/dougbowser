...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.openCourseButton.setGeometry(QtCore.QRect(10, 10, 391, 41))
        ...
        self.saveCourseButton.setGeometry(QtCore.QRect(410, 10, 331, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.openCourseButton.setText(_translate("Form", "Open Decrypted Super Mario Maker 2 Binary Course Data"))
        self.saveCourseButton.setText(_translate("Form", "Save Super Mario Maker 2 Binary Course Data"))
        self.coursePath.setPlaceholderText(_translate("Form", "C:/"))
